...
Public Sub MI_Resource_Plan2()
    ...
    m_sProjectCode = Trim(asPrjInfo(0)) ' This is assuming the project name starts with the Project Code!!
    ...
    If pj.Resources.Count > 0 Then
        ...
        ''24-Jan-17>>>m_sCCResAllocFolder = "\\mffilec\datashare\MIS Resourcing\" + Trim(m_sFiscalYear) + "\"
        ...
        ''24-Jan-17>>>m_sResTrackingFilePath = m_sCCResAllocFolder
