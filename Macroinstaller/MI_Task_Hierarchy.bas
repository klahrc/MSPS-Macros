Attribute VB_Name = "MI_Task_Hierarchy"
...
Public Sub MI_Task_Hierarchy()
    ...
    For Each t In ActiveProject.Tasks
        If Not t Is Nothing Then
            If t.Active Then
                ...
                If t.Summary Then
                    m_rngCol.Font.Bold = True
                    wsSheet1.cells(m_rngCol.row, 1) = "S"
                    wsSheet1.cells(m_rngCol.row, 1).Font.Name = "Kartika"
                    wsSheet1.cells(m_rngCol.row, 1).Font.Size = 8
                ElseIf (t.Duration = 0) Then
                    ...
                    wsSheet1.cells(m_rngCol.row, 1).Font.Size = 8
                Else
                    wsSheet1.cells(m_rngCol.row, 1) = "T"
                    wsSheet1.cells(m_rngCol.row, 1).Font.Name = "Kartika"
                    wsSheet1.cells(m_rngCol.row, 1).Font.Size = 8
                End If
    ...
    MsgBox ("Macro Task Hierarchy Complete with " & iTotTasks & " Tasks Written")
End Sub
