Attribute VB_Name = "MI_Resource_Plan"
...
'////////////////////////////////////////////////////////////
    ...
    With ws1
        ...
        For nMonths = 1 To 12
            ...
            .cells(nStartRow + 1, FISCAL_MONTH_SCHED1_START_COL + nMonths - 1).HorizontalAlignment = xlCenter
            .cells(nStartRow + 1, FISCAL_MONTH_SCHED1_START_COL + nMonths - 1).Interior.Color = RGB(219, 229, 241)    ' Gray
        Next
    ...
    For r = 1 To m_nNumResources
        ...
        ' Now populate infor in Detailed Schedule Table
        dTotResAlloc = 0
        For t = 1 To m_nNumPeriods
            If Not TSVWork1(t).Value = "" And Not TSVWork1(t).Value = 0 Then
                dCellValue = TSVWork1(t).Value / d / 37.5
...
' pjTimescaleYears, pjTimescaleQuarters, pjTimescaleMonths, pjTimescaleWeeks,pjTimescaleDays, pjTimescaleHours, pjTimescaleMinutes
    ...
    If pj.Resources.Count > 0 Then
        ...
        MSP_Res_Plan_Start_Row = LEV_RES_PLAN_START_ROW + pj.ResourceCount + SEPARATOR
        CCL_Spreadsheet_Start_Row = MSP_Res_Plan_Start_Row + pj.ResourceCount + SEPARATOR
        Res_Variance_Start_Row = CCL_Spreadsheet_Start_Row + pj.ResourceCount + SEPARATOR
    ...
    m_wsResPlan.Range(m_wsResPlan.cells(CCL_Spreadsheet_Start_Row + 2, DET_SCHED1_START_COL), _
                      m_wsResPlan.cells(CCL_Spreadsheet_Start_Row + 2 + pj.ResourceCount - 1, DET_SCHED1_START_COL + m_nNumPeriods)).NumberFormat = "#,##0.00"
